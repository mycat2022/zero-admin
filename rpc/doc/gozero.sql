...
Source Database       : gozero

Target Server Type    : MYSQL
Target Server Version : 50727
File Encoding         : 65001

Date: 2022-09-21 00:22:20
*/
...
CREATE TABLE `oms_order_return_apply` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COMMENT='订单退货申请';
...
CREATE TABLE `pay_wx_merchants` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `pay_wx_merchants_id_uindex` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='微信商户信息';
...
CREATE TABLE `pay_wx_record` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `pay_record_id_uindex` (`id`)
...
CREATE TABLE `pms_member_price` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=143 DEFAULT CHARSET=utf8mb4 COMMENT='商品会员价格表';
...
CREATE TABLE `pms_product_attribute_value` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=233 DEFAULT CHARSET=utf8mb4 COMMENT='存储产品参数信息的表';
...
CREATE TABLE `pms_product_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8mb4 COMMENT='产品分类';
...
-- Records of shorturl
-- ----------------------------
INSERT INTO `shorturl` VALUES ('you', 'https://github.com/zeromicro/go-zero');
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='优惠券使用、领取历史表';
...
CREATE TABLE `sms_flash_promotion_product_relation` (
  ...
  `sort` int(11) DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COMMENT='商品限时购与商品关系表';
...
CREATE TABLE `sys_dept` (
  ...
  `del_flag` tinyint(4) DEFAULT '0' COMMENT '是否删除  -1：已删除  0：正常',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COMMENT='机构管理';
...
CREATE TABLE `sys_dict` (
  ...
  `del_flag` tinyint(4) DEFAULT '0' COMMENT '是否删除  -1：已删除  0：正常',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COMMENT='字典表';
...
CREATE TABLE `sys_job` (
  ...
  `last_update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `del_flag` tinyint(4) DEFAULT '0' COMMENT '是否删除  -1：已删除  0：正常',
  `remarks` varchar(68) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='职位管理';
...
CREATE TABLE `sys_log` (
  ...
  `last_update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COMMENT='系统操作日志';
...
CREATE TABLE `sys_login_log` (
  ...
  `last_update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='系统登录日志';
...
CREATE TABLE `sys_menu` (
  ...
  `last_update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `del_flag` tinyint(4) DEFAULT '0' COMMENT '是否删除  -1：已删除  0：正常',
  `vue_path` varchar(64) DEFAULT NULL COMMENT 'vue系统的path',
  `vue_component` varchar(64) DEFAULT NULL COMMENT 'vue的页面',
  `vue_icon` varchar(64) DEFAULT NULL COMMENT 'vue的图标',
  `vue_redirect` varchar(64) DEFAULT NULL COMMENT 'vue的路由重定向',
  `background_url` varchar(128) NOT NULL COMMENT '后台地址',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=105 DEFAULT CHARSET=utf8mb4 COMMENT='菜单管理';
...
CREATE TABLE `sys_role` (
  ...
  `last_update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `del_flag` tinyint(4) DEFAULT '0' COMMENT '是否删除  -1：已删除  0：正常',
  `status` bigint(20) DEFAULT '1' COMMENT '状态  1:启用,0:禁用',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COMMENT='角色管理';
...
CREATE TABLE `sys_role_dept` (
  ...
  `last_update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='角色机构';
...
CREATE TABLE `sys_role_menu` (
  ...
  `last_update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=648 DEFAULT CHARSET=utf8mb4 COMMENT='角色菜单';
...
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8mb4 COMMENT='用户管理';
...
CREATE TABLE `sys_user_role` (
  ...
  `last_update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=88 DEFAULT CHARSET=utf8mb4 COMMENT='用户角色';
